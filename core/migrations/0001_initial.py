    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('step', models.CharField(choices=[('regis', 'Registration'), ('send', 'OTP send'), ('conf_regis', 'Registered'), ('login', 'Login'), ('send_login', 'OTP send'), ('conf_login', 'Logged in')], max_length=256)),
